% ============================================================================
%  MobileNetV2-UNet student — architecture diagram (headline model, 2.41M)
%  Self-contained: compile directly (pdfLaTeX) to get a cropped PDF/figure.
%  Layer specs are exact, taken from code/models/student_unet.py.
%  Colour grammar kept consistent with the DLoc paper's Fig. 5 legend.
% ============================================================================
...
% --- palette (aligned with DLoc Fig. 5) ---
\definecolor{cEnc}{RGB}{142,202,230}     % MobileNetV2 encoder stage (light blue)
\definecolor{cBottle}{RGB}{33,102,172}   % bottleneck (deep blue)
\definecolor{cDec}{RGB}{69,123,157}      % upsample + conv decoder (dark blue)
\definecolor{cHead}{RGB}{188,108,37}     % 1x1 conv + Sigmoid (brown)
\definecolor{cSkip}{RGB}{42,157,143}     % U-Net skip connections (teal)
\definecolor{cIO}{RGB}{230,57,70}        % heatmap input/output accent
...
% ---- Encoder (MobileNetV2, left -> right, downsampling) ----
...
% ---- U-Net skip connections (arc over the top, nested) ----
